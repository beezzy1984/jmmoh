...
for dep in info['depends']:
    if 'jamaica' in dep or 'jmmoh' in dep:
...
setup(
    ...
    description=info.get('description',
                         'Jamaica ePAS Synchronisation Master Module'),
    long_description=read('README.rst'),
    author='Marc Murray',
    author_email='murraym@moh.gov.jm',
    url='http://nhin.mohjm.com',
    download_url='http://nhin.mohjm.com/rcode/pip/',
